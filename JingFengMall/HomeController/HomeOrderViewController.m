...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (_recoderIndex == 0) {
        ...
        if ([cell.Servicelbl.text  isEqual: @"大车搬家"]||[cell.Servicelbl.text  isEqual: @"小车搬家"]||[cell.Servicelbl.text  isEqual: @"中车搬家"]||
            [cell.Servicelbl.text  isEqual: @"货物运输"]) {
            [cell.contentView viewWithTag:1].hidden = YES;
            [cell.contentView viewWithTag:2].hidden = YES;
            [cell.contentView viewWithTag:3].hidden = NO;
            ...
            if ([cell.Servicelbl.text  isEqual: @"大车搬家"]||
                [cell.Servicelbl.text  isEqual: @"小车搬家"]||
                [cell.Servicelbl.text  isEqual: @"中车搬家"]||
                [cell.Servicelbl.text  isEqual: @"货物运输"]){
                [cell.contentView viewWithTag:1].hidden = YES;
                [cell.contentView viewWithTag:2].hidden = NO;
                [cell.contentView viewWithTag:3].hidden = YES;
