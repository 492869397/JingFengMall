    ...
    }else
    {
        ...
        [net accessNetUrl:@"http://123.57.28.11:8080/jfsc_app/selectUserByUserPhone.do" parameters:pass success:^(NSURLSessionDataTask *task, id responseObject) {
            if ([[responseObject objectForKey:@"code"]isEqualToNumber:@1]) {
                ...
                [_contentView.touxiang sd_setImageWithURL:[NSURL URLWithString:url] placeholderImage:[UIImage imageNamed:@"touxiang"]];
                ...
                NSString *cardPrice = [responseObject objectForKey:@"listCardInfo"];
                
                _contentView.cardPrice.text = [NSString stringWithFormat:@"¥%.2lf",[cardPrice doubleValue]];
