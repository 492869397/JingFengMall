...
- (id)initWithText:(NSString*)text
{
    ...
    if (self) {
        ...
        CGRect rect;
        rect.size = CGSizeMake(size.width + 20, size.height + 10);
        rect.origin = CGPointMake(([UIScreen mainScreen].applicationFrame.size.width-rect.size.width)/2, 280);
