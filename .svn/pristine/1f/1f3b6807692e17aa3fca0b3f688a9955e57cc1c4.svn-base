...
- (IBAction)enterCouponView:(id)sender {
    JingFengMoneyViewController *coupon = [[JingFengMoneyViewController alloc]init];
    
    coupon.JingFengCoin = _JingFengCoin;
...
- (IBAction)recharge:(id)sender {
    ...
    [[(UIViewController*)(self.delegate) view]addSubview:view];
