...
//        image.backgroundColor = [UIColor redColor];
        ...
        float leftMargin = 0;
        self.rightCollection=[[UICollectionView alloc] initWithFrame:CGRectMake(kLeftWidth+leftMargin,0,kMainScreenWidth-kLeftWidth-leftMargin,frame.size.height) collectionViewLayout:flowLayout];
...
-(void)getRightData:(NSUInteger)index
{
    ...
    [pass setObject:@"商城" forKey:@"module"];
    [pass setObject:leftCodeArray[index] forKey:@"typeID"];
